...
/**
 * Class KidguardUserUpsellTalkfamilySubscriptions
 * @package ThirdPartyResource\ThirdParty\Api\Kidguard
 */
class KidguardUserUpsellTalkfamilySubscriptions extends BaseApi
{
    use Library;
    use GetData;
    use GetDataCache;
    ...
    protected function getResponse(array $row): ResponseInterface
    {
        ...
        return $this->getClient()->get("/api/cs/users/{$userId}/upsells/talkfamily/subscriptions");
    }
